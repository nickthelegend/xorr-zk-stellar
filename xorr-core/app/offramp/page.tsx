...
const inputCls = "bg-background/50 border-white/10 h-11 w-full rounded-md px-3";
        ...
        <div className="mt-5 space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <select value={rail} onChange={(e) => setRail(e.target.value)} className={`${inputCls} bg-background/50 border border-white/10 text-sm`}>
                {RAILS.map((r) => (
            ...
            <div className="space-y-2">
              ...
              <select value={ccy} onChange={(e) => setCcy(e.target.value)} className={`${inputCls} bg-background/50 border border-white/10 text-sm`}>
                {CURRENCIES.map((c) => (
          ...
          <div className="space-y-2">
            ...
            <Input value={amt} onChange={(e) => setAmt(e.target.value)} className="bg-background/50 border-white/10 h-11 tabular-nums" placeholder="25.0" inputMode="decimal" />
          </div>
          <div className="space-y-2">
            <Label className={labelCls}>Payout handle / IBAN (sandbox)</Label>
            <Input value={handle} onChange={(e) => setHandle(e.target.value)} className="bg-background/50 border-white/10 h-11" placeholder="$alice / GB…" />
          </div>
