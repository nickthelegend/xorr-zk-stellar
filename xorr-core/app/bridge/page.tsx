...
export default function BridgePage() {
  ...
  return (
    <WalletScaffold
      eyebrow="ZK bridge"
      title={`Bridge to ${SHIELDED_SYMBOL}`}
      description="Bridge USDC from Ethereum into private xUSDC on Stellar using a Groth16 proof. No on-chain link exists between your Ethereum deposit and the Stellar claim."
    >
          ...
          <div className="glass-card rounded-3xl p-5 space-y-1.5">
            ...
            {step === "locked" && (
              <div className="space-y-2">
                ...
                <Button
                  ...
                  onClick={claim}
                  className="w-full h-12 font-mono uppercase tracking-widest text-xs bg-gradient-to-r from-primary to-[#7c4dff] text-black"
                >
            ...
            <details className="text-[11px] text-muted-foreground">
              ...
              <div className="mt-2 space-y-1">
                ...
                <Input value={nonce} onChange={(e) => setNonce(e.target.value)} className="h-9 bg-background/50 border-white/10" />
              </div>
            </details>
            ...
            <div className="grid grid-cols-3 gap-2 pt-1">
              {[
                ...
                <div key={s.k} className="rounded-xl border border-white/10 bg-background/40 p-2.5 text-center">
            ...
            <div className="glass-card rounded-2xl p-6 text-center space-y-4">
              ...
              <div className="rounded-xl border border-white/10 divide-y divide-white/5 text-left text-sm">
              ...
              <div className="space-y-2">
                ...
                <Button onClick={reset} className="w-full h-11 font-mono uppercase tracking-widest text-xs">Bridge Again</Button>
              </div>
            </div>
          )
        )}
